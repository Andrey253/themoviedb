    ...
    return Stack(
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(child: Text(this.percent.toString()+'%',
...
class MyPainter extends CustomPainter {
  ...
  void drawFilledArc(Canvas canvas, Rect arcRect) {
    final paint = Paint();
if (this.percent < 20)
    paint.color = lineColor.withAlpha(100);
else
  paint.color = lineColor.withAlpha((2.55*this.percent).toInt());
    //paint.color = Color.fromARGB((2.55*this.percent).toInt(), 255, 0, 0);
